...
public class FinalBossMineMaster : MonoBehaviour {
    public Player_States.ProximityMineMasterTypes MineType;
    public GameObject MinePrefab;
    public GameObject MineObj;
    public FinalBossMine MineScript;
    public FinalBossMineExplosion ExplosionScript;
    ...
    void Start()
    {
        ...
        MineScript = MineObj.GetComponent<FinalBossMine>();
        MineScript.MineType = MineType;
        ExplosionScript = MineObj.transform.GetChild(0).gameObject.GetComponent<FinalBossMineExplosion>();
