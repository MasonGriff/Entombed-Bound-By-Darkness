...
public class FinalBossGhost : MonoBehaviour
{
    public int DamageOutput;

    Collider2D myCollider;

    FinalBossGhostMaster myMaster;
    EnemyHealth myHealth;
    public float InvertTimer = 5f;
    ...
    void Start()
    {
        ...
        myMaster = transform.parent.GetComponent<FinalBossGhostMaster>();
